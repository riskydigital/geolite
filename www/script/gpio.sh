...
GPIO1="/sys/devices/virtual/gpio/gpio20/value"
GPIO2="/sys/devices/virtual/gpio/gpio19/value"
GPIO3="/sys/devices/virtual/gpio/gpio18/value"
GPIO4="/sys/devices/virtual/gpio/gpio22/value"
GPIO5="/sys/devices/virtual/gpio/gpio21/value"


#GPIOS=( "$GPIO1" "$GPIO2" "$GPIO3" "$GPIO4" "$GPIO5" "$GPIO6" "$GPIO7" "$GPIO8" ) # jadikan array
GPIOS=( "$GPIO1" "$GPIO2" "$GPIO3" "$GPIO4" "$GPIO5" ) # jadikan array
